/**
 * 파일명: useIdeaMapEdges.ts
 * 목적: 엣지 관련 상태 및 로직 관리
 * 역할: useIdeaMapStore의 엣지 관련 액션들을 사용하는 래퍼 훅
 * 작성일: 2025-03-28
 * 수정일: 2025-04-11
 * 수정일: 2025-04-21 : 파일명 및 함수명 변경 (useEdges -> useIdeaMapEdges)
 */
